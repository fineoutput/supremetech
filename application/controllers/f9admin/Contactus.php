                ...
                if ($this->form_validation->run()== true) {
                    ...
                    'date'=>$cur_date
                        ...
                        $last_id=$this->base_model->insert_table("tbl_users", $data_insert, 1) ;
												                    ...
												                    if ($last_id!=0) {
												                        $this->session->set_flashdata('smessage', 'Contactus inserted successfully');
...
//     }
                    ...
                    'email'=>$email
                        ...
                        $last_id=$this->db->update('tbl_users', $data_insert);
												                    ...
												                    if ($last_id!=0) {
												                        $this->session->set_flashdata('smessage', 'Contactus updated successfully');
    ...
    public function delete_contactus($idd)
    {
        if (!empty($this->session->userdata('admin_data'))) {
            ...
            if ($this->load->get_var('position')=="Super Admin") {
                ...
                if ($zapak!=0) {
									  $this->session->set_flashdata('smessage', 'Contactus deleted successfully');
    ...
    public function updatecontactusStatus($idd, $t)
    {
        if (!empty($this->session->userdata('admin_data'))) {
         ...
         'is_active'=>1
                ...
                if ($zapak!=0) {
									  $this->session->set_flashdata('smessage', 'Contactus status updated successfully');
                    redirect("dcadmin/contactus/view_contactus", "refresh");
                } else {
                    echo "Error";
                    exit;
