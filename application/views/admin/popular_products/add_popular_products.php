<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Add New Popular_products
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url() ?>dcadmin/home"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a href="<?php echo base_url() ?>dcadmin/Popular_products/view_popular_products"><i class="fa fa-dashboard"></i> All Popular Products </a></li>
    </ol>
  </section>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Popular_products</h3>
          </div>
...
if (!empty($this->session->flashdata('emessage'))) {  ?>
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action=" <?php echo base_url()  ?>dcadmin/Popular_products/add_popular_products_data/<?php echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
