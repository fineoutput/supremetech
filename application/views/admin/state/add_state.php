<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url() ?>dcadmin/Category/view_category"><i class="fa fa-undo" aria-hidden="true"></i> View State </a></li>
    </ol>
  </section>
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <td>
                        <input type="text" name="state_name" class="form-control" placeholder="" required value="" />
                      </td>
                    </tr>
                    <!-- <tr>
