       ...
       <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-10">
                                   <form action="<?php echo base_url() ?>dcadmin/category/add_subcategory_data/<? echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                            ...
                            <tr>
                              ...
                              <tr>
                                  ...
                                  <select class="selectpicker form-control" name="category_id" data-live-search="true" title=" Select Category * ">
                                          <?php foreach ($categories_data->result() as $value){ ?>
