       ...
       <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-10">
                                   <form action="<?php echo base_url() ?>dcadmin/products/add_inventory_data/<? echo base64_encode(1); ?>/<? echo base64_encode($data->product_id); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                      ...
                      <tr>
                          ...
                          <input type="text" name="stocks"  class="form-control" placeholder="" required value="" />
                            ...
                            <tr>
                                                      ...
                                                      <td>
                                <input type="file" name="model_no"  class="form-control" placeholder="" required value="" />
                                                    </td>
                              </tr>
                              <tr>
                                                        <td> <strong>Colour</strong>  <span style="color:red;">*</span></strong> </td>
                                                        <td>
                                  <input type="file" name="colour"  class="form-control" placeholder="" required value="" />
                                                      </td>
                                </tr>
                          <tr>
                            <td colspan="2" >
