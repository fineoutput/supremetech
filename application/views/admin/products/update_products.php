              ...
              <form action=" <?php echo base_url()  ?>dcadmin/Products/add_products_data/<? echo base64_encode(2); ?>/<?= $id; ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                      ...
                      <td>
                        <select class="form-control" id="sid" name="subcategory_id">
                          ...
                          foreach ($subcategory_data->result() as $value) { ?>
                            <option value="<?= $value->id; ?>" <?php if ($products_data->subcategory_id == $value->id) {
                                                                  echo "selected";
                      ...
                      <td>
                        <select class="form-control" id="mid" name="minorcategory_id">
                          ...
                          foreach ($minorcategory_data->result() as $value) { ?>
                            <option value="<?= $value->id; ?>" <?php if ($products_data->minorcategory_id == $value->id) {
                                                                  echo "selected";
                                                                } ?>><?= $value->minorcategoryname; ?></option>
                          <? } ?>
                        </select>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td> <strong>T3 Price</strong> <span style="color:red;">*</span></strong> </td>
                    ...
                    <tr>
                      <td> <strong>T3 Max Limit</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td> <input type="number" required name="t2_price" class="form-control" id="t2_price" placeholder="" value="<?= $products_data->t2_price ?>" /> </td>
                    </tr>
                    <tr>
                      <td> <strong>T2 Min Limit</strong> <span style="color:red;">*</span> </td>
                      <td> <input type="number" required name="t2_min" class="form-control" id="t2_min" placeholder="" value="<?= $products_data->t2_min ?>" /> </td>
                    </tr>
                    <tr>
                      <td> <strong>T2 Max Limit</strong> <span style="color:red;">*</span> </td>
                      <td> <input type="number" required name="t2_max" class="form-control" id="t2_max" placeholder="" value="<?= $products_data->t2_max ?>" /> </td>
                    </tr>
                    <!--<tr>
...
<td> <input type="text" name="gstprice" id="gstprice"  class="form-control" placeholder=""  value="<?= $products_data->gstprice ?>" />  </td>
                    ...
                    <tr>
                      ...
                      <td> <input type="number" name="Inventory" class="form-control" placeholder="" value="<? if (!empty($inventory_data->quantity)) {
                                                                                                              echo $data1 = $inventory_data->quantity;
                                                                                                            } else {
                                                                                                              echo $data1 = "";
                                                                                                            } ?>" /> </td>
                    </tr>
                    ...
                    <td> <select class="form-control" id="featurepid" name="feature_product" value="<?= $products_data->feature_product ?>"> />
                        <option value="yes" <? if ($products_data->feature_product == 1) {
                                              echo "selected";
                                            } ?>>Yes</option>
                        <option value="no" <? if ($products_data->feature_product == 0) {
                                              echo "selected";
                                            } ?>>No</option>
                      </select>
                    </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="polpularpid" name="popular_product" value="<?= $products_data->popular_product ?>"> />
                          <option value="yes" <? if ($products_data->popular_product == 1) {
                                                echo "selected";
                                              } ?>>Yes</option>
                          <option value="no" <? if ($products_data->popular_product == 0) {
                                                echo "selected";
                                              } ?>>No</option>
                        </select>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="brand" name="brands" value="<?= $products_data->brand ?>"> />
                          ...
                          <?php foreach ($brands_data as $brands) { ?>
                            <option value="<?= $brands['id']; ?>" <?php if ($products_data->brand == $brands['id']) {
                                                                    echo "selected";
                                                                  } ?>><?= $brands['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="resolution" name="resolution" value="<?= $products_data->resolution ?>"> />
                          ...
                          <?php foreach ($resolution_data as $resolution) { ?>
                            <option value="<?= $resolution['id']; ?>" <?php if ($products_data->resolution == $resolution['id']) {
                                                                        echo "selected";
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="lens" name="lens" value="<?= $products_data->lens ?>"> />
                          ...
                          <?php foreach ($lens_data as $lens) { ?>
                            <option value="<?= $lens['id']; ?>" <?php if ($products_data->lens == $lens['id']) {
                                                                  echo "selected";
                                                                } ?>><?= $lens['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="irdistance" name="irdistance" value="<?= $products_data->irdistance ?>"> />
                          ...
                          <?php foreach ($irdistance_data as $distance) { ?>
                            <option value="<?= $distance['id']; ?>" <?php if ($products_data->irdistance == $distance['id']) {
                                                                      echo "selected";
                                                                    } ?>><?= $distance['name']; ?></option>
                          <? } ?>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td> <select class="form-control" id="camera" name="cameratype" value="<?= $products_data->cameratype ?>"> />
                          ...
                          <?php foreach ($camera_type as $camera) { ?>
                            <option value="<?= $camera['id']; ?>" <?php if ($products_data->cameratype == $camera['id']) {
                                                                    echo "selected";
                                                                  } ?>><?= $camera['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="bodymaterial" name="bodymaterial" value="<?= $products_data->bodymaterial ?>"> />
                          ...
                          <?php foreach ($body_material as $body) { ?>
                            <option value="<?= $body['id']; ?>" <?php if ($products_data->bodymaterial == $body['id']) {
                                                                  echo "selected";
                                                                } ?>><?= $body['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="videochannel" name="videochannel" value="<?= $products_data->videochannel ?>"> />
                          ...
                          <?php foreach ($video_channel as $video) { ?>
                            <option value="<?= $video['id']; ?>" <?php if ($products_data->videochannel == $video['id']) {
                                                                    echo "selected";
                                                                  } ?>><?= $video['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="povport" name="poeports" value="<?= $products_data->poeports ?>"> />
                          ...
                          <?php foreach ($pov_ports as $port1) { ?>
                            <option value="<?= $port1['id']; ?>" <?php if ($products_data->poeports == $port1['id']) {
                                                                    echo "selected";
                                                                  } ?>><?= $port1['name']; ?></option>
                          <? } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="povtype" name="poetype" value="<?= $products_data->poetype ?>"> />
                          ...
                          <?php foreach ($pov_type as $port) { ?>
                            <option value="<?= $port['id']; ?>" <?php if ($products_data->poetype == $port['id']) {
                                                                  echo "selected";
                                                                } ?>><?= $port['name']; ?></option>
                          <? } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="sataports" name="sataports" value="<?= $products_data->sataports ?>"> />
                          ...
                          <?php foreach ($sata_ports as $sata) { ?>
                            <option value="<?= $sata['id']; ?>" <?php if ($products_data->sataports == $sata['id']) {
                                                                  echo "selected";
                                                                } ?>><?= $sata['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="length" name="length" value="<?= $products_data->length ?>"> />
                          ...
                          <?php foreach ($length_data as $length) { ?>
                            <option value="<?= $length['id']; ?>" <?php if ($products_data->length == $length['id']) {
                                                                    echo "selected";
                                                                  } ?>><?= $length['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="screensize" name="screensize" value="<?= $products_data->screensize ?>"> />
                          ...
                          <?php foreach ($screen_size as $screen) { ?>
                            <option value="<?= $screen['id']; ?>" <?php if ($products_data->screensize == $screen['id']) {
                                                                    echo "selected";
                                                                  } ?>><?= $screen['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="ledtype" name="ledtype" value="<?= $products_data->ledtype ?>"> />
                          ...
                          <?php foreach ($led_type as $led) { ?>
                            <option value="<?= $led['id']; ?>" <?php if ($products_data->ledtype == $led['id']) {
                                                                  echo "selected";
                                                                } ?>><?= $led['name']; ?></option>
                          <? } ?>
                        </select>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="size" name="size_data" value="<?= $products_data->size ?>"> />
                          ...
                          <?php foreach ($size_data as $size) { ?>
                            <option value="<?= $size['id']; ?>" <?php if ($products_data->size == $size['id']) {
                                                                  echo "selected";
                                                                } ?>><?= $size['name']; ?></option>
                          <? } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="nightvision" name="nv_data"> />
                          ...
                          <?php foreach ($night_vision as $night) { ?>
                            <option value="<?= $night['id']; ?>" <? if ($night['id'] == $products_data->night_vision) {
                                                                    echo "selected";
                                                                  } ?>><?= $night['name']; ?></option>
                          <? } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" id="audiotype" name="audiotype"> />
                          ...
                          <?php foreach ($audio_type as $audio) { ?>
                            <option value="<?= $audio['id']; ?>" <? if ($audio['id'] == $products_data->audio_type) {
                                                                    echo "selected";
                                                                  } ?>><?= $audio['name']; ?></option>
                          <? } ?>
                      </td>
