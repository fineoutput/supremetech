                              ...
                              <tr>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                                              ...
                                                              <td>
                                        <input type="text" name="sell_price"  class="form-control" placeholder="" required value="" />
                                                            </td>
                                      </tr>
                                      <tr>
                                                                <td> <strong>Desription</strong>  <span style="color:red;">*</span></strong> </td>
                                                                <td>
                                          <textarea name="description"  class="form-control" placeholder="" required value=""></textarea>
                                                              </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <select class="selectpicker form-control" name="subcategory_id" data-live-search="true" title=" Select Category * ">
                                                    <?php foreach ($subcategories_data->result() as $value){ ?>
