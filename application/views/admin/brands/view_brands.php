<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12">
        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/Brands/add_brands" role="button" style="margin-bottom:12px;"> Add brands</a>
            ...
            <div class="panel-body">
              <div class="box-body table-responsive no-padding">
                <table class="table table-bordered table-hover table-striped" id="userTable">
                  ...
                  <tbody>
                    <?php $i=1; foreach($brands_data->result() as $data) { ?>
                    <tr>
                      <td><?php echo $i ?> </td>
